<form id="frm-edit">
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" value="<?= $details['position']?>" name="position" id="position" required>
        </div>
        <div class="form-group col-md-12">
            <label><span style="color:red">*</span> <?= strtoupper(str_replace("_"," ","full_name"))?></label>
            <input type="text" class="form-control" value="<?= $details['full_name']?>" name="full_name" id="full_name" required>
        </div>
        <div class="form-group col-md-12">
